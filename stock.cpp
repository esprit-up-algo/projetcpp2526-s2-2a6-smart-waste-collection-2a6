...
bool Stock::ajouter()
{
    ...
    QSqlQuery q;
    q.prepare("INSERT INTO MATIERE_PREMIERE (ID_MP, REFERENCE, NOM, QUANTITE, PRIX, SEUIL_CRITIQUE, DATE_FABRICATION, DATE_ACHAT, NUM_FOUR, NOM_FOUR) "
        "VALUES (:ID_MP, :REFERENCE, :NOM, :QUANTITE, :PRIX, :SEUIL_CRITIQUE, :DATE_FABRICATION, :DATE_ACHAT, :NUM_FOUR, :NOM_FOUR)");
...
bool Stock::modifier()
{
    ...
    QSqlQuery q;
    q.prepare("UPDATE MATIERE_PREMIERE SET NOM=:NOM, QUANTITE=:QUANTITE, PRIX=:PRIX, SEUIL_CRITIQUE=:SEUIL_CRITIQUE, DATE_FABRICATION=:DATE_FABRICATION, DATE_ACHAT=:DATE_ACHAT, NUM_FOUR=:NUM_FOUR, NOM_FOUR=:NOM_FOUR WHERE REFERENCE=:REFERENCE");
...
QSqlQueryModel *Stock::afficher()
{
    ...
    model->setQuery("SELECT ID_MP, REFERENCE, NOM, QUANTITE, SEUIL_CRITIQUE, PRIX, DATE_FABRICATION, DATE_ACHAT, NOM_FOUR "
