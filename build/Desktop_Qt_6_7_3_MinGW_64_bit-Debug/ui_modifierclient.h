...
public:
    ...
    void setupUi(QWidget *ModifierClient)
    {
        ...
        ModifierClient->setStyleSheet(QString::fromUtf8("background-color: #F5F5F5;"));
        ...
        vente->setFont(font);
        header = new QWidget(ModifierClient);
...
"    background-color: #1A365D;"));
        ...
        titrePage = new QLabel(ModifierClient);
        titrePage->setObjectName("titrePage");
        titrePage->setGeometry(QRect(210, 100, 400, 41));
        QFont font1;
        font1.setPointSize(16);
        font1.setBold(true);
        titrePage->setFont(font1);
        titrePage->setStyleSheet(QString::fromUtf8("color: #1A365D;"));
        formContainer = new QWidget(ModifierClient);
        ...
        btn_modifier = new QPushButton(ModifierClient);
        btn_modifier->setObjectName("btn_modifier");
        btn_modifier->setGeometry(QRect(650, 580, 200, 40));
        btn_modifier->setStyleSheet(QString::fromUtf8("background-color: #007BFF; color: white; font-weight: bold; border-radius: 5px;"));
        btn_annuler = new QPushButton(ModifierClient);
    ...
    void retranslateUi(QWidget *ModifierClient)
    {
        ...
        titrePage->setText(QCoreApplication::translate("ModifierClient", "Modifier les informations du Client", nullptr));
        labelEntreprise->setText(QCoreApplication::translate("ModifierClient", "Entreprise / Nom :", nullptr));
        labelContact->setText(QCoreApplication::translate("ModifierClient", "Contact :", nullptr));
        labelTelephone->setText(QCoreApplication::translate("ModifierClient", "T\303\251l\303\251phone :", nullptr));
        labelEmail->setText(QCoreApplication::translate("ModifierClient", "Email :", nullptr));
        btn_modifier->setText(QCoreApplication::translate("ModifierClient", "Enregistrer les modifications", nullptr));
        btn_annuler->setText(QCoreApplication::translate("ModifierClient", "Annuler", nullptr));
    } // retranslateUi
