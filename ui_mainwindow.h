...
"text-align: center;"));
        ...
        vboxLayout20->addWidget(label1Success);
...
"                  "));
        ...
        vboxLayout21->addWidget(label2Title);
        ...
        input_date_expiration_ajouter->setMinimumSize(QSize(150, 35));
...
"                  "));
        ...
        input_date_expiration_modifier->setMinimumSize(QSize(150, 35));
