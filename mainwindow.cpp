...

{
    ...
    donutChart->setTitle(QString::fromUtf8("R\xC3\xA9partition Globale (Donut)"));
    ...
    areaChart->setTitle(QString::fromUtf8("\xC3\x89volution Dynamique"));
...
void MainWindow::setupStockTableData()
{
    ...
    auto insertStockRow = [&](int row, int idMp, const QString &ref, const QString &nom, int stockQty, int seuilCritique, const QString &seuilStr, double prix, const QString &fournisseur, const QDate &dateFab, const QDate &dateAchat) {
        ...
        ui->tableWidget->setItem(row, 5, new QTableWidgetItem(fournisseur));
    ...
    if (model->rowCount() == 0) {
        ...
        for(int i = 0; i < model->rowCount(); ++i) {
            ...
            insertStockRow(i, id_mp, ref, nom, stockQty, seuilCritique, seuilStr, prix, fournisseur, dateFab, dateAchat);
        }
    }
...
void MainWindow::on_btnNouveau_client_clicked() {
    ...
    if (ui->stackedWidget_Client) {
        ...
        setSpinBoxValueByNames(this, {"input_bacs_ajouter", "input_contrat_ajouter"}, 0);

        setSpinBoxValueByNames(this, {"input_score_ajouter", "input_contrat_ajouter"}, 0);
...
void MainWindow::on_btn_ajouter_client_clicked() {
    ...
    onClientAdded(ui->input_matricule_ajouter->text(), 
                  ...
                  QString::number(spinBoxValueByNames(this, {"input_bacs_ajouter", "input_contrat_ajouter"}, 0)),

                  QString::number(spinBoxValueByNames(this, {"input_score_ajouter", "input_contrat_ajouter"}, 0)), 
...
void MainWindow::on_btn_modifier_client_clicked() {
    ...
    onClientModified(currentClientRow,
                     ...
                     QString::number(spinBoxValueByNames(this, {"input_bacs_modifier", "input_contrat_modifier"}, 0)),

                     QString::number(spinBoxValueByNames(this, {"input_score_modifier", "input_contrat_modifier"}, 0)), 
...
void MainWindow::addClientActionButtons(int row) {
    ...
    connect(btnEdit, &QPushButton::clicked, this, [this, actionWidget](){
        ...
        setSpinBoxValueByNames(this, {"input_bacs_modifier", "input_contrat_modifier"}, ui->tableWidget_Client->item(r, 3)->text().toInt());

        setSpinBoxValueByNames(this, {"input_score_modifier", "input_contrat_modifier"}, ui->tableWidget_Client->item(r, 4)->text().toInt());
...
void MainWindow::slot_toggleView()
{
    ...
    if (ui->prod_btnToggleView) {
        ui->prod_btnToggleView->setText(QString::fromUtf8(m_isCardView ? "\xE2\x89\xA3" : "\xE2\x97\xA7"));
    }
}
...
QWidget* MainWindow::createProductCard(int row)
{
    ...
    if (stockVal == 0) {
        pIco->setText(QString::fromUcs4(U"\u274C")); pTxt->setText("Rupture de Stock");
...
void MainWindow::on_prod_btnVideo3D_clicked()
{
    ...
    VideoGenerationDialog dialog(productName, reference, capacity, battery, features, this);
    dialog.exec();
}
...
void MainWindow::showClientStats() {
    ...
    if (chartEcoScorePie) {
        ...
        chartEcoScorePie->setChart(pieChart);
